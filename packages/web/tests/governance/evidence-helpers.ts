 ...
 * this file fails, so a final "records evidence" test placed at the end of
 * the same file can refuse to record evidence once an earlier case failed.
 * See packages/governed/tests/acceptance/evidence-helpers.ts for the fuller
 * rationale -- duplicated here (rather than imported cross-package) because
 * it's ~20 lines of test-only glue, not part of either package's public API.
 */
